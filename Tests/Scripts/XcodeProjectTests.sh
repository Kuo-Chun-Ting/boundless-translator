...
readonly GUI_TEST_PROJECT="${PROJECT_ROOT}/Tests/Infrastructure/BoundlessTranslatorTests.xcodeproj"
readonly E2E_TEST_PLAN="${PROJECT_ROOT}/Tests/Infrastructure/BoundlessTranslatorE2ETests.xctestplan"
